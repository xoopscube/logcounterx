...
class MyXoopsGroupPermForm extends XoopsForm
{
    ...
    public function render()
    {
        ...
        $ret = '<br><table width="100%"><tr><th>' . $this->getTitle() . ' &nbsp; ' . $this->_permDesc . '</TH></tr></table>';
        $ret .= "<form name='" . $this->getName() . "' id='" . $this->getName() . "' action='" . $this->getAction() . "' method='" . $this->getMethod() . "'" . $this->getExtra() . " style='margin:0;'>\n<table width='100%' class='outer' cellspacing='1'>\n";
