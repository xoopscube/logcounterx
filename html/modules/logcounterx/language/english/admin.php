...
define('_LCX_ADM_GENCONF', 'Counter Options');
define('_LCX_ADM_LOGCONF', 'Advanced Settings');
...
define('_LCX_ADM_TIMEOFFSET_SVTM', 'Server Time');
define('_LCX_ADM_TIMEOFFSET_ADTM', 'Adjusted Time');
