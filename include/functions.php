...
if (!defined('LCX_LIBRARY_LOADED')) {
     ...
     * @return string
     */
    function lcx_ua2os(string $agent = '')
    {
        if ($agent == '') {
            return 'undefined';
        }
     ...
     * @return mixed|string
     */
    function lcx_ua2br(string $agent = '')
    {
        if ($agent == '') {
            return 'undefined';
        }
    ...
    function lcx_rhshort($rh)
    {
        ...
        // TODO unknow modifier '{'
        // Using / as a delimiter means it also needs to escape it here, like so: \{1,3\}
     ...
     * @return int
     */
    function lcx_LogEval(string $OPTION = '')
    {
        global $xoopsDB;
